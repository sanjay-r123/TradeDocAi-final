          ...
          <div className="relative">
            ...
            <div className="relative rounded-[24px] border border-slate-100 bg-white shadow-[0_8px_20px_rgb(0,0,0,0.04)] p-8 sm:p-10">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-slate-500">Access your TradeDocAI account</p>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                >
                  <p className="text-sm text-indigo-900 font-semibold mb-2">Demo Mode Active</p>
                  <p className="text-sm text-indigo-800 mb-3">
                    Use the demo account to explore all features:
                  </p>
                  <code className="text-xs bg-white px-2.5 py-1.5 rounded-lg border border-indigo-100 block mb-2 text-indigo-700 font-mono">
